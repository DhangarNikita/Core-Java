package java8.collectors.more_practice;
...
public class EmployeeMain {
    public static void main(String[] args) {
        ...
        Map<String, Long> map = emplist.stream().collect(Collectors.groupingBy(emp -> emp.getGender(), Collectors.counting()));
        ...
        Map<String, Double> mapAge = emplist.stream().collect(Collectors.groupingBy(emp -> emp.getGender(), Collectors.averagingDouble(em -> em.getAge())));
        System.out.println(mapAge);

        //4. details Max Salary
        System.out.println("---------------Details of Max Salary----------------");
        // Optional<Employee> empmax =
        ...
        Map<String, Long> count = emplist.stream().collect(Collectors.groupingBy(e -> e.getDepartment(), Collectors.counting()));
        System.out.println(count);

        //7. Average salary of each department
        System.out.println("------------Average salary of each department-----------------");
        Map<String, Double> average = emplist.stream().collect(Collectors.groupingBy(e -> e.getDepartment(), Collectors.averagingDouble(e -> e.getSalary())));
